    ...
    methods: {
        ...
        enter(el, done) {
            ...
            let animation = {
                ...
                60: {
                    transform: `translate3d0, 0, 0) scale(2)`
                },
                100: {
                    transform: `translate3d0, 0, 0) scale(1)`
                }
            }
        ...
        middleTouchStart(e) { // 移动开始 记录移动的位置  ---->在created声明一个this.touch来保存
